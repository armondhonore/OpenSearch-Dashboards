...
**Live:** [https://relaxed-weasel-opensearch.cloud.nexlayer.ai](https://relaxed-weasel-opensearch.cloud.nexlayer.ai)  
...
**opensearch** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/opensearchproject/opensearch-dashboards:latest
    path: /
    servicePorts:
    - 5601
    vars:
